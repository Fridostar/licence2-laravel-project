                ...
                <div class="read-content">
                    <div class="media pt-3 d-sm-flex d-block justify-content-between">
                        <div class="clearfix mb-3">
                            <a href="{{ route('manager.room.index') }}" class="btn btn-primary px-3 my-1 light me-2"><i
                                    class="fa fa-reply me-2"></i> Revenir vers la liste</a>
                        </div>
                        <div class="clearfix mb-3 d-flex">
                            <img src="{{ $room->user->photo }}" class="me-3 rounded" width="70" height="70"
                                alt="image">
        ...
        <div class="card">
            <div class="card-body">
                <div class="post-details">
                        ...
                        <div class="media pt-3 d-sm-flex d-block justify-content-between">
                            <div class="clearfix mb-3 d-flex">
                                <div class="media-body me-2">
                                    ...
                                    <p class="mb-0"><i class="fas fa-calendar-plus me-2"></i>{{ $room->created_at }}</p>
                                    <p class="mb-0">
                                        @if ($room->status == 0)
                    ...
                    <img src="{{ $room->overview_image }}" alt="" class="img-fluid mb-3 w-100 rounded">
